...
@Autonomous(name="Pushbot: Use this during the tournament final Left", group="Pushbot")
@Disabled
public class tempauto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //sleep(1000); this should work as a wait block
            ...
            sleep(10000);
            encoderDrive(TURN_SPEED, 2, -2, 5.0);  // S1: Forward 47 Inches with 5 Sec timeout
        Sensorarm.setPower(-1);
        Sensorarm.setPower(-1);
        Sensorarm.setPower(-1);
